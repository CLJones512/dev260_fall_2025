...
namespace StackLab
{
    ...
    class StudentSkeleton
    {
        ...
        private static Stack<string> indexHistory = new Stack<string>();
        ...
        static void HandlePop()
        {
            ...
            if (actionHistory.Count > 0)
            {
                ...
                totalOperations++;
                Console.WriteLine($"Popped '{poppedAction}' from stack");
                if (actionHistory.Count() != 0)
                {
            ...
            {
                Console.WriteLine("Can't pop from empty history");
            }
        ...
        static void HandlePeek()
        {
            ...
            {
                Console.WriteLine("History is empty. Nothing to peek at.");
            }
        }
