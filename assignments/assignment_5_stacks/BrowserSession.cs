...
namespace Assignment5
{
    ...
    public class BrowserSession
    {
        ...
        public BrowserSession()
        {
            ...
            currentPage = new WebPage("https://google.com", "Google");
        }
        ...
        public void VisitUrl(string url, string title)
        {
            ...
            if (CurrentPage != null)
            {
                ...
                //Console.WriteLine(backStack.Peek());
            }
            forwardStack.Clear();
            CurrentPage!.Url = url;
        ...
        public bool GoBack()
        {
            ...
            {
                Console.WriteLine("No web page to go back to");
                return false;
            }
        }
        ...
        public bool GoForward()
        {
            ...
            {
                Console.WriteLine("No web page to go forward to");
                return false;
            }
        }
        ...
        public void DisplayBackHistory()
        {
            ...
            int i = 1;
            foreach (WebPage webPage in backStack)
            {
                Console.WriteLine($"{i}. {webPage.Title} ({webPage.Url})");
                i++;
            }
        ...
        public void DisplayForwardHistory()
        {
            ...
            int i = 1;
            foreach(WebPage webPage in forwardStack)
            {
                Console.WriteLine($"{i}. {webPage.Title} ({webPage.Url})");
            }
        ...
        public void ClearHistory()
        {
            ...
            Console.WriteLine($"Cleared {totalCleared} pages");
